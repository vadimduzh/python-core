...
# Для списка price_list_4 значения под четными индексами увеличить на 10, а под нечетными на 100.
...
# индексу и увеличить на 10 и сохранить в списке. Если нет, то увеличить на 100 и сохранить в списке.


# Решение 2: Сделать индекс i от 0 с шагом 2 через range.
# Взять элемент по индексу i и увеличить на 10.
# Взять элемент по индексу i + 1 и увеличить на 100.
