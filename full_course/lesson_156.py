...
# TODO: ты взял не первый элемент списка, а число 10, которое совпадает с ним. Т.е. нужно по индексу взять.
min_value = 10
for i in num_list_3:
    if i < min_value:
        min_value = i
...
# TODO: ты взял не первый элемент списка, а число 11, которое совпадает с ним. Т.е. нужно по индексу взять.
max_value = 11
for i in num_list_4:
    if i > max_value:
        max_value = i
...
# TODO: отличный ход! Но ты взял не первый элемент списка, а число 10, которое совпадает с ним.
#  Т.е. нужно по индексу взять.
min_value2 = max_value2 = 10
for i in num_list_5:
    if i > max_value2:
        max_value2 = i
    elif i < min_value2:
        min_value2 = i
print(min_value2, max_value2)
